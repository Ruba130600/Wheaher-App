...
function App() {
  ...
  var [input, inputSet] = useState('trichy')
  var [main, mainSet] = useState('Clouds')
  var [description, descriptionSet] = useState('Broken Clouds')
  var [temp, tempset] = useState('24')
  function getData() {
    console.log()
    var fetchstatus = fetch("https://api.openweathermap.org/data/2.5/weather?q=" + input 
    + "&appid=ee949cc184264765ad2f53c854eb1a81").then(function (res) {
      return res.json()
    })
  ...
  return (
    <div className="background">
      <div className="container">
        <h1 className="wheather"> <b>WEATHER</b></h1>
        <input type="text" className="Inputcls" placeholder="City Name" id='inputid' onChange={inputVal} value={input} /><br /><br />
